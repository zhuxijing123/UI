...
function App() {
  ...
  const viewportNodes = useMemo(
    () => flattenUiViewportNodes(uiHierarchy, STAGE_SIZE.width, STAGE_SIZE.height),
    [uiHierarchy]
  );
